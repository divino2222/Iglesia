...
export type PastoralTeamStatus = {
  id: string;
  teamName: string;
  emoji: string | null;
  assigned: number;
...
export async function getPastoralCenterData(): Promise<
  PastoralService | null
> {
